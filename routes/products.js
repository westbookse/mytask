...
//测试地址: http://localhost:3000/products?kwords=macbook i5 128g
router.get("/",(req,res)=>{
  ...
  var sql="SELECT *,( SELECT md from ola_laptop_pic where laptop_id=family_id limit 1 ) as md FROM ola_laptop";
